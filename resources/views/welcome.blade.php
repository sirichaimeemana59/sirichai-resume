    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                <li class="nav-item"><a class="nav-link js-scroll-trigger" data-toggle="modal" data-target="#myModal-Login" type="button">{!! trans('messages.home.login') !!}</a></li>
...
<header class="masthead">
    <div class="container">
        ...
        <button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#myModal-Register">{!! trans('messages.home.regis') !!}</button>
    </div>
</header>
...
<div class="modal fade" id="myModal-Login" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::model(null,array('url' => array('/login'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
